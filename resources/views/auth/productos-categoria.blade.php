        ...
        <div class="">
          <div class="row col-md-12" style="padding:1.5rem;">
            <form class="range-field">
              ...
              <input type="range" id="min-price" data-id="{{$productos[0]->categoria_id}}" data-self="category" min="0" max="5000" />
            </form>
            <form class="range-field">
              <label for="max-price" id="max-price-l" class="blue-grey-text">A: $<span>0</span></label>
              <input type="range" id="max-price" data-id="{{$productos[0]->categoria_id}}" data-self="category" min="0" max="5000" />
            </form>
          </div>
        </div>
      </div>
